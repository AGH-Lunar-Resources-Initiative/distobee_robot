...
class WheelDriver(rclpy.node.Node):
    ...
    def on_target_wheel_states(self, msg: WheelStates):
        ...
        front_left_msg.input_mode = 3  # PASSTHROUGH
        # front_left_msg.input_pos = msg.front_left_angle / (2 * M_PI) + 0.365  # No offset necessary, everything is done in odrive firmware
        ...
        front_right_msg.input_mode = 3 # PASSTHROUGH
